# The apps.py file defines the configuration for the Plans application.
...
class PlansConfig(AppConfig):
    """
    Configure the Plans application and provide metadata used by Django
    ...
    # identify and register the Plans application within the project.
    name = 'plans'
